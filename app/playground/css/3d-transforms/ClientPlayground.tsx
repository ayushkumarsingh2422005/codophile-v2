...
import { PlaygroundGuideModal, PlaygroundHelpButton } from "@/components/playground/PlaygroundGuideModal";
        ...
        <div className="min-h-screen bg-[#030014] text-white selection:bg-cyan-500/30 font-sans">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <PlaygroundHelpButton
                                ...
                                ariaLabel="Learn about CSS 3D transforms in this playground"
            ...
            {guideOpen && (
                <PlaygroundGuideModal
                    doc={THREE_D_TRANSFORMS_DOC}
                    onClose={closeGuide}
                    titleId="3d-transforms-doc-title"
                />
            )}
